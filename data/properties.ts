...
export type Property = {
  ...
  floor: number;
  totalFloors: number;
  floorCategory?: 'first' | 'middle' | 'last';
  year: number;
  ...
  return createProperty(
    {
      ...
      floorCategory: input.floorCategory,
      year: input.year,
      buildingMaterial: 'Монолит',
      renovation: input.renovation,
      furniture: input.furniture,
...
export const properties: Property[] = [
  ...
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-4you-middle-025', complexName: '4YOU', rooms: 3, price: 195_000_000, area: 123, kitchenArea: 15, floor: 7, totalFloors: 8, floorCategory: 'middle', year: 2023, renovation: 'Евроремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['Жилой комплекс от BI Group', 'Закрытый и благоустроенный двор', 'Квартира полностью готова к заселению', 'Парковочное место входит в стоимость', 'Хорошая транспортная доступность', 'Просторная площадь для трехкомнатной квартиры', 'Высокие потолки 3 метра'], cons: [], fitFor: ['Семья с детьми', 'Молодая семья', 'Покупатель, которому нужна готовая квартира без ремонта', 'Тем, кому важно наличие собственного парковочного места'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000021', aiSummary: 'Просторная трехкомнатная квартира площадью 123 м² в ЖК 4YOU. Подойдет семье, которая ищет полностью готовое жилье в современном комплексе с закрытым двором. Квартира продается с мебелью, техникой и парковочным местом, поэтому после покупки можно сразу заселяться.', matchPercent: 91, imageOffset: 0 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-estet-middle-026', complexName: 'Estet', rooms: 3, price: 129_000_000, area: 128, kitchenArea: 10, floor: 2, totalFloors: 12, floorCategory: 'middle', year: 2024, renovation: 'Хороший ремонт', furniture: 'Частично', appliances: 'Частично', elevator: '2 лифта', ceilingHeight: 3, pros: ['Свежий ремонт', 'После ремонта никто не проживал', 'Новая мебель и техника', 'Просторная площадь 128 м²', 'Красивый вид из окна', 'Высокие межкомнатные двери 2,2 метра', 'Высота потолков 3 метра', 'Дом 2024 года постройки'], cons: ['Квартира укомплектована мебелью и техникой только частично'], fitFor: ['Молодая семья', 'Семья с детьми', 'Покупатель, который ищет свежий ремонт', 'Тем, кто хочет самостоятельно дополнить интерьер мебелью'], sellingReason: 'Переезд в квартиру большей площади.', ownerPhone: '87770000022', aiSummary: 'Просторная трехкомнатная квартира площадью 128 м² в новом доме 2024 года. После ремонта никто не проживал, поэтому покупатель получает практически новую квартиру. Подойдет семье, которая хочет современное жилье и готова самостоятельно завершить меблировку.', matchPercent: 89, imageOffset: 1 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-riviera-middle-027', complexName: 'Riviera', rooms: 3, price: 105_000_000, area: 103, kitchenArea: 12, floor: 9, totalFloors: 16, floorCategory: 'middle', year: 2026, renovation: 'Черновая отделка', furniture: 'Нет', appliances: 'Нет', elevator: '2 лифта', ceilingHeight: 3, pros: ['Жилой комплекс от Bazis-A', 'Закрытый двор', 'Функциональная планировка', 'Можно реализовать собственный дизайн-проект', 'Средний этаж', 'Высокие потолки 3 метра', 'Новый жилой комплекс'], cons: ['Требуется полный ремонт', 'После покупки потребуются дополнительные расходы на отделку', 'Квартира продается без мебели и техники'], fitFor: ['Тем, кто хочет сделать ремонт под себя', 'Покупатель со собственным дизайн-проектом', 'Семья, которая не хочет переплачивать за чужой ремонт', 'Инвестор, планирующий отделку и последующую перепродажу'], sellingReason: 'Изменились семейные планы.', ownerPhone: '87770000023', aiSummary: 'Трехкомнатная квартира площадью 103 м² в ЖК Riviera для покупателей, которые хотят создать интерьер полностью под себя. Черновая отделка потребует дополнительных вложений, но позволит не переплачивать за ремонт, который пришлось бы переделывать.', matchPercent: 86, imageOffset: 2 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-afd-plaza-middle-028', complexName: 'AFD PLAZA', rooms: 3, price: 142_000_000, area: 131, kitchenArea: 10, floor: 9, totalFloors: 21, floorCategory: 'middle', year: 2021, renovation: 'Старый ремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['Жилой комплекс от Bazis-A', 'Закрытый двор', 'Большая площадь 131 м²', 'Функциональная планировка', 'Развитая инфраструктура района', 'Квартира полностью меблирована', 'Бытовая техника остается', 'Высокие потолки 3 метра'], cons: ['Ремонт желательно обновить', 'Часть отделочных материалов и интерьерных решений может быть устаревшей'], fitFor: ['Семья с детьми', 'Покупатель, которому важна большая площадь', 'Тем, кто готов постепенно обновить ремонт', 'Покупатель, которому нужна квартира с мебелью и техникой'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000024', aiSummary: 'Самая просторная квартира в этой подборке — 131 м². Подойдет семье, которой важны большая площадь, развитая инфраструктура и готовая комплектация мебелью и техникой. Ремонт пригоден для проживания, но в дальнейшем его желательно обновить.', matchPercent: 87, imageOffset: 0 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-4you-first-029', complexName: '4YOU', rooms: 3, price: 185_000_000, area: 123, kitchenArea: 15, floor: 1, totalFloors: 8, floorCategory: 'first', year: 2023, renovation: 'Евроремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от BI Group', 'Закрытый двор', 'Полностью готова к заселению', 'Парковочное место в подарок', 'Отличная транспортная доступность'], cons: [], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000025', aiSummary: 'Трехкомнатная квартира в ЖК 4YOU на первом этаже. Подойдет тем, кто ищет просторную готовую квартиру с евроремонтом, мебелью, техникой и парковочным местом.', matchPercent: 90, imageOffset: 0 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-2room-estet-first-030', complexName: 'Estet', rooms: 2, price: 122_000_000, area: 128, kitchenArea: 10, floor: 1, totalFloors: 12, floorCategory: 'first', year: 2024, renovation: 'Хороший ремонт', furniture: 'Частично', appliances: 'Частично', elevator: '2 лифта', ceilingHeight: 3, pros: ['Свежий ремонт', 'Никто не проживал', 'Новая мебель и техника', 'Красивый вид', 'Высокие двери 2.2 м'], cons: [], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Переезд в квартиру большей площади.', ownerPhone: '87770000026', aiSummary: 'Двухкомнатная квартира в ЖК Estet на первом этаже. Свежий ремонт, новая мебель и техника частично уже есть, поэтому квартиру можно быстро подготовить к проживанию.', matchPercent: 88, imageOffset: 1 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-riviera-first-031', complexName: 'Riviera', rooms: 3, price: 95_000_000, area: 103, kitchenArea: 12, floor: 1, totalFloors: 16, floorCategory: 'first', year: 2026, renovation: 'Черновая отделка', furniture: 'Нет', appliances: 'Нет', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от Bazis-A', 'Закрытый двор', 'Отличная планировка', 'Можно сделать ремонт под себя'], cons: ['Требуется полный ремонт'], fitFor: ['Тем, кто хочет сделать дизайн квартиры полностью под себя'], sellingReason: 'Изменились семейные планы.', ownerPhone: '87770000027', aiSummary: 'Трехкомнатная квартира в ЖК Riviera на первом этаже в черновой отделке. Хороший вариант для покупателя, который хочет сам продумать планировку, материалы и стиль ремонта.', matchPercent: 85, imageOffset: 2 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-afd-plaza-first-032', complexName: 'AFD PLAZA', rooms: 3, price: 135_000_000, area: 131, kitchenArea: 10, floor: 1, totalFloors: 21, floorCategory: 'first', year: 2021, renovation: 'Старый ремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от Bazis-A', 'Закрытый двор', 'Хорошая планировка', 'Развитая инфраструктура'], cons: ['Желательно обновить ремонт'], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000028', aiSummary: 'Просторная трехкомнатная квартира в AFD PLAZA на первом этаже. Подойдет тем, кому важны большая площадь, закрытый двор и развитая инфраструктура, а ремонт можно обновить постепенно.', matchPercent: 87, imageOffset: 0 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-4you-last-033', complexName: '4YOU', rooms: 3, price: 187_000_000, area: 123, kitchenArea: 15, floor: 8, totalFloors: 8, floorCategory: 'last', year: 2023, renovation: 'Евроремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от BI Group', 'Закрытый двор', 'Полностью готова к заселению', 'Парковочное место в подарок', 'Отличная транспортная доступность'], cons: [], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000029', aiSummary: 'Трехкомнатная квартира в ЖК 4YOU на последнем этаже. Подойдет тем, кто ищет просторную готовую квартиру с евроремонтом, мебелью, техникой и парковочным местом.', matchPercent: 89, imageOffset: 0 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-2room-estet-last-034', complexName: 'Estet', rooms: 2, price: 124_000_000, area: 128, kitchenArea: 10, floor: 12, totalFloors: 12, floorCategory: 'last', year: 2024, renovation: 'Хороший ремонт', furniture: 'Частично', appliances: 'Частично', elevator: '2 лифта', ceilingHeight: 3, pros: ['Свежий ремонт', 'Никто не проживал', 'Новая мебель и техника', 'Красивый вид из окна', 'Высота дверей 2,2 м'], cons: [], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Переезд в квартиру большей площади.', ownerPhone: '87770000030', aiSummary: 'Двухкомнатная квартира в ЖК Estet на последнем этаже. Свежий ремонт, красивый вид из окна и частичная комплектация мебелью и техникой делают ее удобным вариантом для быстрого переезда.', matchPercent: 87, imageOffset: 1 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-riviera-last-035', complexName: 'Riviera', rooms: 3, price: 95_000_000, area: 103, kitchenArea: 12, floor: 16, totalFloors: 16, floorCategory: 'last', year: 2026, renovation: 'Черновая отделка', furniture: 'Нет', appliances: 'Нет', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от Bazis-A', 'Закрытый двор', 'Отличная планировка', 'Подходит для ремонта под себя'], cons: ['Требуется полный ремонт'], fitFor: ['Тем, кто хочет самостоятельно разработать дизайн и сделать ремонт под себя'], sellingReason: 'Изменились семейные планы.', ownerPhone: '87770000031', aiSummary: 'Трехкомнатная квартира в ЖК Riviera на последнем этаже в черновой отделке. Подойдет покупателю, который хочет самостоятельно разработать дизайн и сделать ремонт под себя.', matchPercent: 84, imageOffset: 2 }),
  createBostandykOneRoomProperty({ id: 'bostandyk-3room-afd-plaza-last-036', complexName: 'AFD PLAZA', rooms: 3, price: 135_000_000, area: 131, kitchenArea: 10, floor: 21, totalFloors: 21, floorCategory: 'last', year: 2021, renovation: 'Старый ремонт', furniture: 'Полностью', appliances: 'Полностью', elevator: '2 лифта', ceilingHeight: 3, pros: ['ЖК от Bazis-A', 'Закрытый двор', 'Хорошая планировка', 'Развитая инфраструктура района'], cons: ['Желательно обновить ремонт'], fitFor: ['Молодой семье', 'Одному человеку'], sellingReason: 'Покупаем квартиру большей площади.', ownerPhone: '87770000032', aiSummary: 'Просторная трехкомнатная квартира в AFD PLAZA на последнем этаже. Подойдет тем, кому важны большая площадь, закрытый двор и развитая инфраструктура района.', matchPercent: 86, imageOffset: 0 }),
